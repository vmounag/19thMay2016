...
public class FilmServiceImpl implements IFilmService {
	...
	public String  AddFilm(Map filmlist) throws ParseException,FieldEmptyException,NegativeNumberException
	{
	   ...
	   film.setLength((Integer) filmlist.get(6));
		...
		if(film.getLength()<0 || film.getRental_duration()<0 || film.getRental_rate()<0) 
		{
			throw new NegativeNumberException();
		}
		
		if(film.getTitle()==null || film.getDescription()==null||film.getReplacement_cost()==null||film.getRating()==null||film.getLength()==0 || film.getRental_duration()==0 || film.getRental_rate()==0||film.getSpecial_features()==null||film.getCategory()==null||film.getLanguage()==null)       
		{
		...
		else return filmdao.addFilm(film);
...
public	Film searchFilm(Integer film_id) throws FieldEmptyException, NegativeNumberException
	{
	if(film_id==0){
		throw new FieldEmptyException();
	}
